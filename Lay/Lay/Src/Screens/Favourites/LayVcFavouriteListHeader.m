...
@implementation LayVcFavouriteListHeader
...
-(void)dealloc {
    MWLogDebug([LayVcFavouriteListHeader class], @"dealloc");
}
...
-(void)updateLabel {
    ...
    NSString *numberOfItemsLabel = NSLocalizedString(@"CatalogNumberOfFavouritesLabel", nil);
